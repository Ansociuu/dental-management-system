    ...
    <nav className={`fixed top-0 left-0 w-full z-[1000] transition-all duration-300 ${
      ...
      <div className="container-max flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-4 z-50 relative">
          ...
          <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-container)] text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-[var(--color-primary)]/30 transition-all hover:-translate-y-0.5 active:scale-95 hidden sm:block">
            Đặt lịch ngay
          </button>
      ...
      >
        <div className="flex flex-col p-4 gap-2 bg-white">
          ...
          <div className="flex flex-col gap-3 sm:hidden pb-4">
            <button className="font-semibold text-white bg-[var(--color-tertiary)] text-center p-3 rounded-xl shadow-lg shadow-[var(--color-tertiary)]/20 active:scale-95 transition-transform">
              Đặt lịch ngay
            </button>
